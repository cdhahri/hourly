...
for user_id in ids:
  ...
  w = '/vagrant/data/osn-data/features_step1/{}count_negative_word.json'.format(user_id)
...
for f in files:
  ...
  w = '/vagrant/data/osn-data/features_step1/mentions/past_tweets/{}count_negative_word.json'.format(user_id)
