...
for user_id in ids:
  ...
  w = '/vagrant/data/osn-data/features_step1/{}count_exclamation_mark.json'.format(user_id)
  process(r, w)
...
for f in files:
  ...
  w = '/vagrant/data/osn-data/features_step1/mentions/past_tweets/{}count_exclamation_mark.json'.format(user_id)
  process(r, w)
'''
